...
import mutator.MutationTestingApp.MutationTestingAppStandaloneAPI;

public class MutationTestingAppStandaloneAPILauncher {
	public static void createMutants(String inputFolder, String outputFolder)
		...
		mutatorNames.add("MutationTestingApp");
		List<List<String>> operatorNames = new ArrayList<List<String>>();
		List<String> mutatorOperatorNamesMutationTestingApp = new ArrayList<String>();
		mutatorOperatorNamesMutationTestingApp.add("m1");
		mutatorOperatorNamesMutationTestingApp.add("m2");
		operatorNames.add(mutatorOperatorNamesMutationTestingApp);
		...
		String inputWodelFolder = "C:/4diac-ide/workspace/MutationTestingApp/data/model";
		...
		File projectFolder = new File(
				MutationTestingAppStandaloneAPI.class.getProtectionDomain().getCodeSource().getLocation().getPath());
		List<String> mutatorList = MutatorUtils.getMutators(projectFolder.listFiles());
		String outputWodelFolder = MutationTestingAppStandaloneAPI.class.getProtectionDomain().getCodeSource()
				.getLocation().getPath() + "data/out";
		IOUtils.deleteFolder(outputWodelFolder, "model", mutatorList);
		i = 0;
		MutationTestingAppStandaloneAPI.createMutants(arrOperatorNames[i]);
		i++;
