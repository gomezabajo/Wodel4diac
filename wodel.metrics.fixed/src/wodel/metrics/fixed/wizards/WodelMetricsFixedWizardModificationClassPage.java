...
/**
 * @author Pablo Gomez-Abajo - Wodel meta-model static footprints modification class wizard page
 * 
 */

public class WodelMetricsFixedWizardModificationClassPage extends WizardPage {
	...
	public WodelMetricsFixedWizardModificationClassPage(ISelection selection, List<EPackage> mutatorPackages, Resource model, List<EPackage> packages, String className) {
		super("wizardMetricsFixedModificationClassPage");
