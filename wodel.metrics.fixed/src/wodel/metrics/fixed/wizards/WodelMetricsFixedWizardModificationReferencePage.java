...
/**
 * @author Pablo Gomez-Abajo - Wodel meta-model static footprints modification reference wizard page
 * 
 */
...
public class WodelMetricsFixedWizardModificationReferencePage extends WizardPage {
	...
	public WodelMetricsFixedWizardModificationReferencePage(ISelection selection, List<EPackage> mutatorPackages, Resource model, List<EPackage> packages, String className, String referenceName) {
