...
/**
 * @author Pablo Gomez-Abajo - Wodel meta-model static footprints references wizard page
 * 
 */

public class WodelMetricsFixedWizardReferencePage extends WizardPage {
	...
	public WodelMetricsFixedWizardReferencePage(ISelection selection, List<EPackage> mutatorPackages, Resource model, List<EPackage> packages, String className, String referenceName) {
		super("wizardMetricsFixedReferencePage");
		...
		List<EClass> mutatorClasses = MutatorUtils.getModificationReferenceClassMutators(mutatorPackages);
