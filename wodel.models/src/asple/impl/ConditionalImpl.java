...
public class ConditionalImpl extends StatementImpl implements Conditional {
	...
	protected EClass eStaticClass() {
		return AsplePackage.Literals.CONDITIONAL;
	}
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AsplePackage.CONDITIONAL__EXPRESSION, oldExpression, newExpression);
	...
	public void setExpression(Expression newExpression) {
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AsplePackage.CONDITIONAL__EXPRESSION, null, msgs);
			if (newExpression != null)
				msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AsplePackage.CONDITIONAL__EXPRESSION, null, msgs);
			msgs = basicSetExpression(newExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsplePackage.CONDITIONAL__EXPRESSION, newExpression, newExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AsplePackage.CONDITIONAL__EXPRESSION:
				return basicSetExpression(null, msgs);
			case AsplePackage.CONDITIONAL__IF:
				return ((InternalEList<?>)getIf()).basicRemove(otherEnd, msgs);
			case AsplePackage.CONDITIONAL__ELSE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case AsplePackage.CONDITIONAL__IF:
				getIf().clear();
				getIf().addAll((Collection<? extends Statement>)newValue);
				return;
			case AsplePackage.CONDITIONAL__ELSE:
				getElse().clear();
