 ...
 * </p>
 * <ul>
 *   <li>{@link asple.impl.ProgramImpl#getDeclarations <em>Declarations</em>}</li>
 *   <li>{@link asple.impl.ProgramImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProgramImpl extends MinimalEObjectImpl.Container implements Program {
	...
	protected EClass eStaticClass() {
		return AsplePackage.Literals.PROGRAM;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AsplePackage.PROGRAM__DECLARATIONS:
				return ((InternalEList<?>)getDeclarations()).basicRemove(otherEnd, msgs);
			case AsplePackage.PROGRAM__STATEMENTS:
