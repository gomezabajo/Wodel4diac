...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Attribute Copy</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link mutatorenvironment.impl.AttributeCopyImpl#getObject <em>Object</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeCopyImpl extends AttributeSetImpl implements AttributeCopy {
	...
	public void setObject(ObSelectionStrategy newObject) {
		if (newObject != object) {
			...
			if (newObject != null)
				msgs = ((InternalEObject)newObject).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MutatorenvironmentPackage.ATTRIBUTE_COPY__OBJECT, null, msgs);
			msgs = basicSetObject(newObject, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorenvironmentPackage.ATTRIBUTE_COPY__OBJECT, newObject, newObject));
	}
