...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Random Integer Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class RandomIntegerTypeImpl extends IntegerTypeImpl implements RandomIntegerType {
	...
	public void setMin(int newMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorenvironmentPackage.RANDOM_INTEGER_TYPE__MIN, oldMin, min));
	}
	...
	public void setMax(int newMax) {
		...
		max = newMax;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorenvironmentPackage.RANDOM_INTEGER_TYPE__MAX, oldMax, max));
	}
	...
	public void setAllowsNull(boolean newAllowsNull) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatorenvironmentPackage.RANDOM_INTEGER_TYPE__ALLOWS_NULL, oldAllowsNull, allowsNull));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MutatorenvironmentPackage.RANDOM_INTEGER_TYPE__MAX:
				return getMax();
			case MutatorenvironmentPackage.RANDOM_INTEGER_TYPE__ALLOWS_NULL:
				return isAllowsNull();
		}
