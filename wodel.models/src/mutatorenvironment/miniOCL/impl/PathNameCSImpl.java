 ...
 * </p>
 * <ul>
 *   <li>{@link mutatorenvironment.miniOCL.impl.PathNameCSImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PathNameCSImpl extends MinimalEObjectImpl.Container implements PathNameCS {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case MiniOCLPackage.PATH_NAME_CS__PATH:
				getPath().clear();
				getPath().addAll((Collection<? extends PathCS>)newValue);
				return;
		}
