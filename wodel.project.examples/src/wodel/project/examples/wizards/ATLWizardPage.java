...
/**
 * @author Pablo Gomez-Abajo - Wodel new ATL Atlas Tranformation Language example project Wizard page.
 * 
 * Wodel new ATL Atlas Tranformation Language example project Wizard.
 *  
 */


public class ATLWizardPage extends WizardPage {
	...
	protected ATLWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("New Wodel ATL Atlas Transformation Language Example");
		setDescription("This wizard creates a new Wodel ATL Atlas Transformation Language Example.");
	...
	private void initialize() {
		...
		this.projectText.setText("ATL");
		this.fileText.setText("ATL.mutator");
