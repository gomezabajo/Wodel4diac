...
/**
 * @author Pablo Gomez-Abajo - Wodel new ASPLE example project Wizard page.
 * 
 * Wodel new ASPLE example project Wizard.
 *  
 */

public class AspleWizardPage extends WizardPage {
	...
	protected AspleWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("New Wodel ASPLE Language Example");
		setDescription("This wizard creates a new Wodel ASPLE Language Example.");
