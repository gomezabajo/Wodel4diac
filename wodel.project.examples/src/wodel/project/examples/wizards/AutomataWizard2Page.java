...
/**
 * @author Pablo Gomez-Abajo - Wodel new Automata 2 example project Wizard page.
 * 
 * Wodel new Automata 2 example project Wizard page.
 *  
 */

public class AutomataWizard2Page extends WizardPage {
	...
	protected AutomataWizard2Page(ISelection selection) {
		super("wizardPage");
