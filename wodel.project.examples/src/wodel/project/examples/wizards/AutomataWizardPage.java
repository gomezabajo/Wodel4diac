...
/**
 * @author Pablo Gomez-Abajo - Wodel new Automata example project Wizard page.
 * 
 * Wodel new Automata example project Wizard page.
 *  
 */

public class AutomataWizardPage extends WizardPage {
	...
	protected AutomataWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("New Wodel Finite Automata Example");
		setDescription("This wizard creates a new Wodel Finite Automata Example.");
	...
	private void initialize() {
		...
		this.projectText.setText("fa1");
		this.fileText.setText("fa1.mutator");
