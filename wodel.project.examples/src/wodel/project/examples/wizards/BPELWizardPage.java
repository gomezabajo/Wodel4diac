...
/**
 * @author Pablo Gomez-Abajo - Wodel new BPEL example project Wizard page.
 * 
 * Wodel new BPEL example project Wizard page.
 *  
 */

public class BPELWizardPage extends WizardPage {
	...
	protected BPELWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("New BPEL Example");
		setDescription("This wizard creates a new BPEL Example.");
