...
/**
 * @author Pablo Gomez-Abajo - Wodel new BPMN example project Wizard page.
 * 
 * Wodel new BPEL example project Wizard page.
 *  
 */

public class BPMNWizardPage extends WizardPage {
	...
	protected BPMNWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("New BPMN Example");
		setDescription("This wizard creates a new BPMN Example.");
	...
	private void initialize() {
		...
		this.projectText.setText("bpmn");
		this.fileText.setText("bpmn.mutator");
