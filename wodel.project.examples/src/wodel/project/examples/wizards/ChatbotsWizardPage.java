...
/**
 * @author Pablo Gomez-Abajo - Wodel new chatbots example project Wizard page.
 * 
 * Wodel new chatbots example project Wizard page.
 *  
 */
public class ChatbotsWizardPage extends WizardPage {
	...
	protected ChatbotsWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("New Wodel Chatbots Example");
		setDescription("This wizard creates a new Wodel Chatbots Example.");
	...
	private void initialize() {
		...
		this.projectText.setText("chatbots");
		this.fileText.setText("chatbots.mutator");
