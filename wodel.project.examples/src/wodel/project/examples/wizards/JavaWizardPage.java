...
/**
 * @author Pablo Gomez-Abajo - Wodel new Java example project Wizard page.
 * 
 * Wodel new Java example project Wizard.
 *  
 */

public class JavaWizardPage extends WizardPage {
	...
	protected JavaWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("New Wodel Java Language Example");
		setDescription("This wizard creates a new Wodel Java Language Example.");
	...
	private void initialize() {
		...
		this.projectText.setText("java");
		this.fileText.setText("java.mutator");
