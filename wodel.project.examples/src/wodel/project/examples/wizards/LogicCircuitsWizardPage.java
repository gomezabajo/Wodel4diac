...
/**
 * @author Pablo Gomez-Abajo - Wodel new logic circuits example project Wizard page.
 * 
 * Wodel new logic circuits example project Wizard page.
 *  
 */

public class LogicCircuitsWizardPage extends WizardPage {
	...
	protected LogicCircuitsWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("New Wodel Logic Circuits Language Example");
		setDescription("This wizard creates a new Wodel Logic Circuits Language Example.");
	...
	private void initialize() {
		...
		this.projectText.setText("lc");
		this.fileText.setText("lc.mutator");
