...
/**
 * @author Pablo Gomez-Abajo - Wodel new probabilistic automata example project Wizard page.
 * 
 * Wodel new probabilistic automata example project Wizard page.
 *  
 */

public class PFSMWizardPage extends WizardPage {
	...
	protected PFSMWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("New Wodel Probabilistic Automata Example");
		setDescription("This wizard creates a new Wodel Probabilistic Automata Example.");
