...
/**
 * @author Pablo Gomez-Abajo - Wodel new security policies example project Wizard page.
 * 
 * Wodel new security policies example project Wizard page.
 *  
 */
public class SecurityPoliciesWizardPage extends WizardPage {
	...
	protected SecurityPoliciesWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("New Wodel Security Policies Example");
		setDescription("This wizard creates a new Wodel Security Policies Example.");
