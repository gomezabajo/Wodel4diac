...
public class UMLCDWizardPage extends WizardPage {
	...
	protected UMLCDWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("New Wodel UML Class Diagrams Language Example (2)");
		setDescription("This wizard creates a new Wodel UML Class Diagrams Language Example (2).");
	...
	private void initialize() {
		...
		this.projectText.setText("umlCD2");
		this.fileText.setText("umlCD2.mutator");
