 ...
 * 
 * MultiplyOperationConfigurationStrategy arithmetic multiply operation
 *  
 */

public class MultiplyOperationConfigurationStrategy extends	ArithmeticOperationConfigurationStrategy {

	private int intValue = 0;
	private double doubleValue = 0.0;
	private EAttribute attribute = null;
	
	public MultiplyOperationConfigurationStrategy(List<EPackage> packages, Resource model, String className, String a2m, EObject object, Object value) {
