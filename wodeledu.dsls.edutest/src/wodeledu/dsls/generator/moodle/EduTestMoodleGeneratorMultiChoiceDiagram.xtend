...
class EduTestMoodleGeneratorMultiChoiceDiagram {
	var MultiChoiceDiagram exercise
	...
	def String setUpAndCompile(EduTestSuperGenerator generator, MultiChoiceDiagram exercise, Program program, Resource resource, List<Integer> li, List<EClass> roots) {
...
<text><![CDATA[<p>«test.question.replace("\"", "'")»<br></p><p><img width="30%" height="30%" src="data:image/png;base64,«generator.getStringBase64("diagrams/" + test.source.replace('.model', '') + "/" + statement)»"><br></p><!--<p><img src="@@PLUGINFILE@@/exercise_«uuid».png" alt="«test.question.replace("\"", "'")»" width="30%" height="30%" class="img-responsive atto_image_button_text-bottom"><br></p>-->]]></text>
«ELSE»
...
<text><![CDATA[<p><img width="«size»%" height="«size»%" src="data:image/png;base64,«generator.getStringBase64("diagrams/" + test.source.replace('.model', '') + "/" + diagram)»"><br></p>]]></text>
