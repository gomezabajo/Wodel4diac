...
public class EduTestMoodleGeneratorAlternativeText {
  private AlternativeText exercise;
  ...
  public String setUpAndCompile(final EduTestSuperGenerator generator, final AlternativeText exercise, final Program program, final Resource resource, final List<Integer> li, final List<EClass> roots) {
    this.project = EduTestMoodleGeneratorAlternativeText.projectOf(resource);
    ...
    try {
      ...
      }
      {
        ...
        for(final Test test : _tests) {
          String _xifexpression = null;
          List<String> _get = this.generator.getDiagrams().get(this.exercise).get(test).get(answersClass);
          boolean _tripleNotEquals = (_get != null);
          if (_tripleNotEquals) {
            String _xifexpression_1 = null;
            int _size_1 = this.generator.getDiagrams().get(this.exercise).get(test).get(answersClass).size();
            boolean _greaterThan_1 = (_size_1 > 0);
            if (_greaterThan_1) {
              _xifexpression_1 = this.generator.getDiagrams().get(this.exercise).get(test).get(answersClass).get(0);
            }
            ...
            if (((this.generator.getDiagrams().get(this.exercise).get(test).get(answersClass) != null) && (this.generator.getDiagrams().get(this.exercise).get(test).get(answersClass).size() > 0))) {
              ...
              _builder.newLineIfNotEmpty();
              {
                if ((file.isFile() && file.exists())) {
                  ...
                  _builder.newLine();
                  _builder.append("<!--");
                  String _identifier = ((AlternativeText) this.exercise).getConfig().getIdentifier();
                  String _metaModelPath = ModelManager.getMetaModelPath();
                  String _plus_3 = (_metaModelPath + "/");
                  String _source = test.getSource();
                  String _plus_4 = (_plus_3 + _source);
                  _builder.append(text = this.generator.getText(_identifier, _plus_4, resource));
                  _builder.append("-->");
                  _builder.newLineIfNotEmpty();
                  _builder.newLine();
                  _builder.append("<!--");
                  ...
                  String _plus_5 = ("diagrams/" + _replace_3);
                  String _plus_6 = (_plus_5 + "/");
                  String _plus_7 = (_plus_6 + diagram);
                  String _stringBase64 = this.generator.getStringBase64(_plus_7);
                  ...
                  String _replace_5 = test.getSource().replace(".model", "");
                  String _plus_8 = ("diagrams/" + _replace_5);
                  String _plus_9 = (_plus_8 + "/");
                  String _plus_10 = (_plus_9 + diagram);
                  String _stringBase64_1 = this.generator.getStringBase64(_plus_10);
