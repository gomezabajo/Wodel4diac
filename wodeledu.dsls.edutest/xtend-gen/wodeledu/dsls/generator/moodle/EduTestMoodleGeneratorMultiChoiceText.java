...
public class EduTestMoodleGeneratorMultiChoiceText {
  private MultiChoiceText exercise;
  ...
  public String setUpAndCompile(final EduTestSuperGenerator generator, final MultiChoiceText exercise, final Program program, final Resource resource, final List<Integer> li, final List<EClass> roots) {
    this.project = EduTestMoodleGeneratorMultiChoiceText.projectOf(resource);
      ...
      }
      {
        ...
        for(final Test test_1 : _tests_1) {
          ...
          if ((statement == null)) {
            ...
            List<String> _get_1 = this.generator.getPrograms().get(this.exercise).get(test_1).get(statementClass);
            boolean _tripleNotEquals_1 = (_get_1 != null);
            if (_tripleNotEquals_1) {
              String _xifexpression_4 = null;
              int _size_2 = this.generator.getPrograms().get(this.exercise).get(test_1).get(statementClass).size();
              boolean _greaterThan_2 = (_size_2 > 0);
              if (_greaterThan_2) {
                _xifexpression_4 = this.generator.getPrograms().get(this.exercise).get(test_1).get(statementClass).get(0);
              } else {
          ...
          String _statement = statement = _xifexpression_2;
          _builder.append(_statement);
          _builder.newLineIfNotEmpty();
          String _xifexpression_5 = null;
          List<String> _get_2 = this.generator.getDiagrams().get(this.exercise).get(test_1).get(answersClass);
          boolean _tripleNotEquals_2 = (_get_2 != null);
          if (_tripleNotEquals_2) {
            String _xifexpression_6 = null;
            int _size_3 = this.generator.getDiagrams().get(this.exercise).get(test_1).get(answersClass).size();
            boolean _greaterThan_3 = (_size_3 > 0);
            if (_greaterThan_3) {
              _xifexpression_6 = this.generator.getDiagrams().get(this.exercise).get(test_1).get(answersClass).get(0);
            }
            _xifexpression_5 = _xifexpression_6;
          }
          String solution = _xifexpression_5;
          _builder.newLineIfNotEmpty();
          String _xifexpression_7 = null;
          if ((solution == null)) {
            String _xifexpression_8 = null;
            List<String> _get_3 = this.generator.getPrograms().get(this.exercise).get(test_1).get(answersClass);
            boolean _tripleNotEquals_3 = (_get_3 != null);
            if (_tripleNotEquals_3) {
              String _xifexpression_9 = null;
              int _size_4 = this.generator.getPrograms().get(this.exercise).get(test_1).get(answersClass).size();
              boolean _greaterThan_4 = (_size_4 > 0);
              if (_greaterThan_4) {
                _xifexpression_9 = this.generator.getPrograms().get(this.exercise).get(test_1).get(answersClass).get(0);
              }
              _xifexpression_8 = _xifexpression_9;
            }
            _xifexpression_7 = _xifexpression_8;
          }
          String _solution = solution = _xifexpression_7;
          _builder.append(_solution);
          _builder.newLineIfNotEmpty();
          ...
          _builder.newLineIfNotEmpty();
          {
            if (((this.generator.getDiagrams().get(this.exercise).get(test_1).get(answersClass) != null) && (this.generator.getDiagrams().get(this.exercise).get(test_1).get(answersClass).size() > 0))) {
              ...
              String diagram = (_plus_1 + statement);
              _builder.append("-->");
              _builder.newLineIfNotEmpty();
              {
                int _length = diagram.length();
                boolean _greaterThan_5 = (_length > 0);
                if (_greaterThan_5) {
                  _builder.append("<!--");
                  ...
                  _builder.newLineIfNotEmpty();
                  {
                    if ((file.isFile() && file.exists())) {
                      ...
                      {
                        int _indexOf = diagram.indexOf("/src-gen/html/");
                        int _length_1 = "/src-gen/html/".length();
                        int _plus_2 = (_indexOf + _length_1);
                        diagram = diagram.substring(_plus_2, diagram.length());
                      ...
                      int _xblockexpression_12 = (int) 0;
                      {
                        i++;
                        _xblockexpression_12 = i;
                      }
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        for(final String answer : answers) {
                          ...
                          _builder.newLineIfNotEmpty();
                          {
                            List<String> _get_4 = this.generator.getSolutionsMap().get(this.exercise);
                            for(final String sol : _get_4) {
                              {
                                if ((((answer.startsWith((sol + "/")) || answer.startsWith((sol + "\\"))) || answer.contains((((sol + "/") + answersClass.getName()) + "_"))) || answer.contains((((sol + "\\") + answersClass.getName()) + "_")))) {
                          ...
                          _builder.newLineIfNotEmpty();
                          {
                            if ((s || answer.equals(solution))) {
                              String _identifier = ((MultiChoiceText) this.exercise).getConfig().getIdentifier();
                              String _metaModelPath = ModelManager.getMetaModelPath();
                              String _plus_2 = (_metaModelPath + "/");
                              String _source = test_1.getSource();
                              String _plus_3 = (_plus_2 + _source);
                              String text = this.generator.getText(_identifier, _plus_3, resource);
                              _builder.newLineIfNotEmpty();
                              {
                                if (((100 % solutions) == 0)) {
                              ...
                              String _plus_4 = ("diagrams/" + _replace_2);
                              String _plus_5 = (_plus_4 + "/");
                              String _plus_6 = (_plus_5 + answer);
                              String _stringBase64_2 = this.generator.getStringBase64(_plus_6);
                              _builder.append(_stringBase64_2);
                              _builder.append("\"><br></p>]]></text>");
                              _builder.newLineIfNotEmpty();
                              _builder.append("<!--<text><![CDATA[<p>");
                              _builder.append(text);
                              _builder.append("</p><p><img src=\"@@PLUGINFILE@@/exercise_");
                              _builder.append(uuid);
                              ...
                              String _plus_7 = ("diagrams/" + _replace_3);
                              String _plus_8 = (_plus_7 + "/");
                              String _plus_9 = (_plus_8 + answer);
                              String _stringBase64_3 = this.generator.getStringBase64(_plus_9);
                            ...
                            } else {
                              {
                                if ((counter_1 < (min - 1))) {
                                  ...
                                  _builder.newLineIfNotEmpty();
                                  String _identifier_1 = ((MultiChoiceText) this.exercise).getConfig().getIdentifier();
                                  String _outputPath = ModelManager.getOutputPath();
                                  String _plus_10 = (_outputPath + "/");
                                  String _replace_4 = test_1.getSource().replace(".model", "");
                                  String _plus_11 = (_plus_10 + _replace_4);
                                  String _plus_12 = (_plus_11 + "/");
                                  String _name = answersClass.getName();
                                  String _plus_13 = (_name + "_");
                                  String _replace_5 = diagram.replace(_plus_13, "");
                                  String _name_1 = answersClass.getName();
                                  String _plus_14 = (_name_1 + "_");
                                  String _replace_6 = _replace_5.replace(_plus_14, "").replace(".png", ".model");
                                  String _plus_15 = (_plus_12 + _replace_6);
                                  String text_1 = this.generator.getText(_identifier_1, _plus_15, resource);
                                  _builder.newLineIfNotEmpty();
                                  ...
                                  String _plus_16 = ("diagrams/" + _replace_7);
                                  String _plus_17 = (_plus_16 + "/");
                                  String _plus_18 = (_plus_17 + answer);
                                  String _stringBase64_4 = this.generator.getStringBase64(_plus_18);
          ...
          {
            if (((this.generator.getPrograms().get(this.exercise).get(test_1).get(answersClass) != null) && (this.generator.getPrograms().get(this.exercise).get(test_1).get(answersClass).size() > 0))) {
              String _xblockexpression_19 = null;
              {
                answersSet.addAll(this.generator.getPrograms().get(this.exercise).get(test_1).get(answersClass));
              ...
              String _plus_19 = ((((this.workspacePath + "/") + this.projectName) + "/src-gen/html/code/") + _replace_8);
              String _plus_20 = (_plus_19 + "/");
              String prog = (_plus_20 + statement);
              _builder.append("-->");
              _builder.newLineIfNotEmpty();
              {
                int _length_1 = prog.length();
                boolean _greaterThan_6 = (_length_1 > 0);
                if (_greaterThan_6) {
                  _builder.append("<!--");
                  File file_1 = new File(prog);
                  _builder.append("-->");
                  _builder.newLineIfNotEmpty();
                  {
                    if ((file_1.isFile() && file_1.exists())) {
                      ...
                      {
                        int _indexOf = prog.indexOf("/src-gen/html/");
                        int _length_2 = "/src-gen/html/".length();
                        int _plus_21 = (_indexOf + _length_2);
                        prog = prog.substring(_plus_21, prog.length());
                      ...
                      _builder.newLine();
                      _builder.append("<text>Question ");
                      int _xblockexpression_23 = (int) 0;
                      {
                        i++;
                        _xblockexpression_23 = i;
                      }
                      ...
                      _builder.append("-->");
                      _builder.newLineIfNotEmpty();
                      _builder.append("<text><![CDATA[<div>");
                      String _replace_9 = test_1.getQuestion().replace("\"", "\'");
                      _builder.append(_replace_9);
                      _builder.append("<br><img src=\"@@PLUGINFILE@@/exercise_");
                      _builder.append(uuid_1);
                      _builder.append(".png\" alt=\"\" width=\"30%\" height=\"30%\" role=\"presentation\" class=\"img-responsive atto_image_button_text-bottom\"><br></div>]]></text>");
                      _builder.newLineIfNotEmpty();
                      _builder.append("<text><![CDATA[<div>");
                      String _pythonHtmlCode = this.generator.getPythonHtmlCode(prog);
                      ...
                      _builder.newLine();
                      {
                        Mode _mode_2 = this.exercise.getConfig().getMode();
                        boolean _tripleEquals_2 = (_mode_2 == Mode.RADIOBUTTON);
                        if (_tripleEquals_2) {
                          _builder.append("<single>true</single>");
                          _builder.newLine();
                        } else {
                          Mode _mode_3 = this.exercise.getConfig().getMode();
                      ...
                      _builder.newLineIfNotEmpty();
                      {
                        for(final String answer_1 : answers) {
                          _builder.append("<!--");
                          boolean s_1 = false;
                          _builder.append("-->");
                          _builder.newLineIfNotEmpty();
                          {
                            List<String> _get_5 = this.generator.getSolutionsMap().get(this.exercise);
                            for(final String sol_1 : _get_5) {
                              {
                                if ((((answer_1.startsWith((sol_1 + "/")) || answer_1.startsWith((sol_1 + "\\"))) || answer_1.contains((((sol_1 + "/") + answersClass.getName()) + "_"))) || answer_1.contains((((sol_1 + "\\") + answersClass.getName()) + "_")))) {
                          ...
                          _builder.newLineIfNotEmpty();
                          {
                            if ((s_1 || answer_1.equals(solution))) {
                              {
                              ...
                              _builder.append("<text><![CDATA[<div>");
                              String _replace_10 = test_1.getSource().replace(".model", "");
                              String _plus_21 = ("code/" + _replace_10);
                              String _plus_22 = (_plus_21 + "/");
                              String _plus_23 = (_plus_22 + answer_1);
                              String _pythonHtmlCode_1 = this.generator.getPythonHtmlCode(_plus_23);
                            ...
                            } else {
                              {
                                if ((counter_2 < (min - 1))) {
                                  ...
                                  _builder.newLine();
                                  _builder.append("<text><![CDATA[<div>");
                                  String _replace_11 = test_1.getSource().replace(".model", "");
                                  String _plus_24 = ("code/" + _replace_11);
                                  String _plus_25 = (_plus_24 + "/");
                                  String _plus_26 = (_plus_25 + answer_1);
                                  String _pythonHtmlCode_2 = this.generator.getPythonHtmlCode(_plus_26);
                                  _builder.append(_pythonHtmlCode_2);
                                  _builder.append("</div>]]></text>");
                                  _builder.newLineIfNotEmpty();
                                  _builder.append("<feedback format=\"html\">");
                                  _builder.newLine();
