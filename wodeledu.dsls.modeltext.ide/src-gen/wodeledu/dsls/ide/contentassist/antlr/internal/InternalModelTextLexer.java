...
public class InternalModelTextLexer extends Lexer {
    ...
    public final void mT__11() throws RecognitionException {
        try {
            ...
            // InternalModelText.g:11:7: ( 'type' )
            // InternalModelText.g:11:9: 'type'
            {
            match("type"); 
    ...
    public final void mT__12() throws RecognitionException {
        try {
            int _type = T__12;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalModelText.g:12:7: ( 'metamodel' )
            // InternalModelText.g:12:9: 'metamodel'
            {
            match("metamodel"); 
    ...
    public final void mT__20() throws RecognitionException {
        try {
            int _type = T__20;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalModelText.g:20:7: ( ',' )
            // InternalModelText.g:20:9: ','
            {
            match(','); 
    ...
    public final void mT__23() throws RecognitionException {
        try {
            int _type = T__23;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalModelText.g:23:7: ( '%' )
            // InternalModelText.g:23:9: '%'
            {
            match('%'); 
    ...
    public final void mT__24() throws RecognitionException {
        try {
            int _type = T__24;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalModelText.g:24:7: ( 'not' )
            // InternalModelText.g:24:9: 'not'
            {
            match("not"); 
    ...
    public final void mT__25() throws RecognitionException {
        try {
            int _type = T__25;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalModelText.g:25:7: ( 'null' )
            // InternalModelText.g:25:9: 'null'
            {
            match("null"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalModelText.g:1965:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalModelText.g:1965:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalModelText.g:1965:11: ( '^' )?
            int alt1=2;
            ...
            // InternalModelText.g:1965:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalModelText.g:1967:10: ( ( '0' .. '9' )+ )
            // InternalModelText.g:1967:12: ( '0' .. '9' )+
            {
            // InternalModelText.g:1967:12: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
            do {
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalModelText.g:1967:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalModelText.g:1969:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalModelText.g:1969:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalModelText.g:1969:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalModelText.g:1969:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalModelText.g:1969:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                    ...
                    break;
                case 2 :
                    // InternalModelText.g:1969:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalModelText.g:1969:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalModelText.g:1971:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalModelText.g:1971:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalModelText.g:1971:24: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalModelText.g:1973:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalModelText.g:1973:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalModelText.g:1973:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalModelText.g:1975:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalModelText.g:1975:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalModelText.g:1975:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalModelText.g:1977:16: ( . )
            // InternalModelText.g:1977:18: .
            {
            matchAny(); 
    ...
    static final String DFA12_eotS =
        "\1\uffff\2\30\10\uffff\2\26\1\uffff\1\30\1\26\2\uffff\3\26\2\uffff\1\30\1\uffff\1\30\13\uffff\2\30\5\uffff\2\30\1\62\1\30\1\64\1\30\1\uffff\1\66\1\uffff\1\30\1\uffff\3\30\1\73\1\uffff";
    static final String DFA12_eofS =
        "\74\uffff";
    static final String DFA12_minS =
        "\1\0\1\171\1\145\10\uffff\1\76\1\75\1\uffff\1\157\1\101\2\uffff\2\0\1\52\2\uffff\1\160\1\uffff\1\164\13\uffff\1\164\1\154\5\uffff\1\145\1\141\1\60\1\154\1\60\1\155\1\uffff\1\60\1\uffff\1\157\1\uffff\1\144\1\145\1\154\1\60\1\uffff";
    static final String DFA12_maxS =
        "\1\uffff\1\171\1\145\10\uffff\1\76\1\75\1\uffff\1\165\1\172\2\uffff\2\uffff\1\57\2\uffff\1\160\1\uffff\1\164\13\uffff\1\164\1\154\5\uffff\1\145\1\141\1\172\1\154\1\172\1\155\1\uffff\1\172\1\uffff\1\157\1\uffff\1\144\1\145\1\154\1\172\1\uffff";
    static final String DFA12_acceptS =
        "\3\uffff\1\3\1\4\1\5\1\6\1\7\1\10\1\11\1\12\2\uffff\1\15\2\uffff\1\20\1\21\3\uffff\1\25\1\26\1\uffff\1\20\1\uffff\1\3\1\4\1\5\1\6\1\7\1\10\1\11\1\12\1\13\1\14\1\15\2\uffff\1\21\1\22\1\23\1\24\1\25\6\uffff\1\16\1\uffff\1\1\1\uffff\1\17\4\uffff\1\2";
    static final String DFA12_specialS =
        "\1\0\21\uffff\1\1\1\2\50\uffff}>";
    static final String[] DFA12_transitionS = {
            "\11\26\2\25\2\26\1\25\22\26\1\25\1\26\1\22\2\26\1\15\1\26\1\23\1\10\1\11\2\26\1\12\1\13\1\7\1\24\12\21\1\6\2\26\1\14\1\5\2\26\32\20\3\26\1\17\1\20\1\26\14\20\1\2\1\16\5\20\1\1\6\20\1\3\1\26\1\4\uff82\26",
            "\1\27",
            "\1\31",
            "",
            "",
