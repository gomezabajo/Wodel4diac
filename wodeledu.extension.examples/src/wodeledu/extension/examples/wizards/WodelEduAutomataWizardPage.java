...
public class WodelEduAutomataWizardPage extends WizardPage {
	...
	protected WodelEduAutomataWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("New Wodel-Edu Finite Automata Example");
		setDescription("This wizard creates a new Wodel-Edu Finite Automata Example.");
