...
public class WodelEduLogicCircuitsWizardPage extends WizardPage {
	...
	protected WodelEduLogicCircuitsWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("New Wodel-Edu Logic Circuits Example");
		setDescription("This wizard creates a new Wodel-Edu Logic Circuits Example.");
	...
	private void initialize() {
		...
		this.projectText.setText("eduLC");
		this.fileText.setText("eduLC.mutator");
