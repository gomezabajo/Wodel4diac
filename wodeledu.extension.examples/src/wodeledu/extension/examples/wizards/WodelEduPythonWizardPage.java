...
/**
 * @author Pablo Gomez-Abajo - Wodel new Wodel-Edu for Python project Wizard page.
 * 
 * Wodel new Wodel-Edu for Python project Wizard page.
 *  
 */

public class WodelEduPythonWizardPage extends WizardPage {
	...
	protected WodelEduPythonWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("New Wodel-Edu Python Example");
		setDescription("This wizard creates a new Wodel-Edu Python Example.");
	...
	private void initialize() {
		...
		this.projectText.setText("eduPy");
		this.fileText.setText("eduPy.mutator");
