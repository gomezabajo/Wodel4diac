...
public class WodelEduUMLCDWizardPage extends WizardPage {
	...
	protected WodelEduUMLCDWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("New Wodel-Edu UML Class Diagrams Example");
		setDescription("This wizard creates a new Wodel-Edu UML Class Diagrams Example.");
	...
	private void initialize() {
		...
		this.projectText.setText("eduCD");
		this.fileText.setText("eduCD.mutator");
