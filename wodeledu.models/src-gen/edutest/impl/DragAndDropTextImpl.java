	...
	public NotificationChain basicSetConfig(TestConfiguration newConfig, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					EdutestPackage.DRAG_AND_DROP_TEXT__CONFIG, oldConfig, newConfig);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newConfig != config) {
			...
			if (config != null)
				msgs = ((InternalEObject) config).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - EdutestPackage.DRAG_AND_DROP_TEXT__CONFIG, null, msgs);
			if (newConfig != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EdutestPackage.DRAG_AND_DROP_TEXT__CONFIG, newConfig,
					newConfig));
	}
