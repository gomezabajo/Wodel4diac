	...
	public NotificationChain basicSetConfig(TextConfiguration newConfig, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					EdutestPackage.MATCH_PAIRS__CONFIG, oldConfig, newConfig);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newConfig != config) {
			...
			if (config != null)
				msgs = ((InternalEObject) config).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - EdutestPackage.MATCH_PAIRS__CONFIG, null, msgs);
			if (newConfig != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EdutestPackage.MATCH_PAIRS__CONFIG, newConfig,
					newConfig));
	}
