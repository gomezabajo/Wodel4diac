	...
	public NotificationChain basicSetConfig(TestConfiguration newConfig, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					EdutestPackage.MULTI_CHOICE_DIAGRAM__CONFIG, oldConfig, newConfig);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newConfig != config) {
			...
			if (config != null)
				msgs = ((InternalEObject) config).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - EdutestPackage.MULTI_CHOICE_DIAGRAM__CONFIG, null, msgs);
			if (newConfig != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, EdutestPackage.MULTI_CHOICE_DIAGRAM__CONFIG,
					newConfig, newConfig));
	}
