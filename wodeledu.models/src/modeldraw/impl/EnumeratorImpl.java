 ...
 * </p>
 * <ul>
 *   <li>{@link modeldraw.impl.EnumeratorImpl#getLiteral <em>Literal</em>}</li>
 *   <li>{@link modeldraw.impl.EnumeratorImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumeratorImpl extends MinimalEObjectImpl.Container implements Enumerator {
	...
	protected EClass eStaticClass() {
		return ModeldrawPackage.Literals.ENUMERATOR;
	}
		...
		if (literal != null && literal.eIsProxy()) {
			...
			if (literal != oldLiteral) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModeldrawPackage.ENUMERATOR__LITERAL, oldLiteral, literal));
			}
		}
		return literal;
	}
	...
	public void setLiteral(EEnumLiteral newLiteral) {
		...
		literal = newLiteral;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModeldrawPackage.ENUMERATOR__LITERAL, oldLiteral, literal));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModeldrawPackage.ENUMERATOR__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModeldrawPackage.ENUMERATOR__LITERAL:
				if (resolve) return getLiteral();
				return basicGetLiteral();
			case ModeldrawPackage.ENUMERATOR__VALUE:
				return getValue();
		}
