 ...
 * </p>
 * <ul>
 *   <li>{@link modeldraw.impl.ItemImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ItemImpl extends MinimalEObjectImpl.Container implements Item {
	...
	protected EClass eStaticClass() {
		return ModeldrawPackage.Literals.ITEM;
	}
		...
		if (name != null && name.eIsProxy()) {
			...
			if (name != oldName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModeldrawPackage.ITEM__NAME, oldName, name));
			}
		}
		return name;
	}
	...
	public void setName(EClass newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModeldrawPackage.ITEM__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModeldrawPackage.ITEM__NAME:
