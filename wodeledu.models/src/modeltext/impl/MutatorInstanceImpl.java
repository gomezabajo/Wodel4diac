 ...
 * </p>
 * <ul>
 *   <li>{@link modeltext.impl.MutatorInstanceImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MutatorInstanceImpl extends ItemImpl implements MutatorInstance {
	...
	protected EClass eStaticClass() {
		return ModeltextPackage.Literals.MUTATOR_INSTANCE;
	}
	...
	public EList<Element> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Element>(Element.class, this, ModeltextPackage.MUTATOR_INSTANCE__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModeltextPackage.MUTATOR_INSTANCE__ELEMENTS:
