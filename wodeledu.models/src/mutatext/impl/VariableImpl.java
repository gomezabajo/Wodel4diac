 ...
 * </p>
 * <ul>
 *   <li>{@link mutatext.impl.VariableImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableImpl extends WordImpl implements Variable {
	...
	protected EClass eStaticClass() {
		return MutatextPackage.Literals.VARIABLE;
	}
	...
	public void setType(VariableType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MutatextPackage.VARIABLE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MutatextPackage.VARIABLE__TYPE:
				return getType();
		}
