 ...
 * @generated
 */
public class MutatextSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MutatextPackage.CONSTANT: {
				...
				if (result == null) result = caseWord(constant);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MutatextPackage.VARIABLE: {
				...
				if (result == null) result = caseWord(variable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
