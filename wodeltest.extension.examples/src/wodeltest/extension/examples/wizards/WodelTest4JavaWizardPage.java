...
public class WodelTest4JavaWizardPage extends WizardPage {
	...
	protected WodelTest4JavaWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("Wodel-Test for Java Example");
		setDescription("This wizard creates a new Wodel-Test for Java Example project.");
