...
public class WodelTest4LCWizardPage extends WizardPage {
	...
	protected WodelTest4LCWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("Wodel-Test for LC Example");
		setDescription("This wizard creates a new Wodel-Test for LC example project.");
