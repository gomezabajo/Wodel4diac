...
public class WodelTest4ATLUpdateSiteWizardPage extends WizardPage {
	...
	protected WodelTest4ATLUpdateSiteWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("Wodel-Test for ATL update-site generator");
		setDescription("This wizard creates the Wodel-Test for ATL update-site plugin.");
