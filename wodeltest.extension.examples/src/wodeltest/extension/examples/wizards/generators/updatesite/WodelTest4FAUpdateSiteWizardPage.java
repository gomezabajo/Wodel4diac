...
public class WodelTest4FAUpdateSiteWizardPage extends WizardPage {
	...
	protected WodelTest4FAUpdateSiteWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("Wodel-Test for FA update-site generator");
		setDescription("This wizard creates the Wodel-Test for FA update-site plugin project.");
