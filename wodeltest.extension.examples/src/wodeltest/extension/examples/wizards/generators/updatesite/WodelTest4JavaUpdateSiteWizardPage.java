...
public class WodelTest4JavaUpdateSiteWizardPage extends WizardPage {
	...
	protected WodelTest4JavaUpdateSiteWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("Wodel-Test for Java update-site");
		setDescription("This wizard creates the Wodel-Test for Java update-site plugin.");
	...
	private void initialize() {
		...
		this.projectText.setText("WodelTest4Java");
		this.fileText.setText("WodelTest4Java.mutator");
