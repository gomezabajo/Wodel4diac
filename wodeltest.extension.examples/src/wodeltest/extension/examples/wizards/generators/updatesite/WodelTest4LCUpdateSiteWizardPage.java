...
public class WodelTest4LCUpdateSiteWizardPage extends WizardPage {
	...
	protected WodelTest4LCUpdateSiteWizardPage(ISelection selection) {
		super("wizardPage");
		setTitle("Wodel-Test for LC update-site generator");
		setDescription("This wizard creates the Wodel-Test for LC update-site plugin project.");
	...
	private void initialize() {
		...
		this.projectText.setText("WodelTest4LC");
		this.fileText.setText("WodelTest4LC.mutator");
